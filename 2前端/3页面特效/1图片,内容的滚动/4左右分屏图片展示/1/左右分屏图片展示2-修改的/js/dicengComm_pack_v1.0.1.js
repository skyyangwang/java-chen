...
TencentArticl=
{
	...
	Count:function()
	{
	 ...
	 SildTab:function(now)
	 {
		...
		if(parseInt(this.$(this.tabSilder).style.left)>-200*parseInt(this.Now*4))
		{
			this.moveR();
		}else
		{
	...
	moveR:function(setp)
	{
		...
		var _distance=50;
		if(_curLeft>-200*parseInt(this.Now*4))
		{
			this.$(this.tabSilder).style.left=(_curLeft-_distance)+40+"px";
